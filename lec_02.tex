...
\paragraph{Law of Demand} % Insert Figure 3-1
...
\paragraph{Changes in Quantity Demanded} % Insert handmade graph
\paragraph{Determinants of Demand}
\paragraph{Changes in Demand} % Insert Figure 3-3

\subsection{Supply}
\paragraph{Definition}
\paragraph{Law of Supply} % Insert Supply Curve (handmade)
\paragraph{Individual vs. Market Supply}
Calculated the same as demand.
\paragraph{Changes in Quantity Supplied} % Insert handmade graph
